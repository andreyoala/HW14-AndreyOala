...
class SecondGalleryListCollectionViewCell: UICollectionViewCell {

    static let identifier = "SecondGalleryListCollectionViewCell"
...
extension SecondGalleryListCollectionViewCell {
    func configure() {
